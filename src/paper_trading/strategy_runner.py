...
class StrategyRunner:
    ...
    def on_new_bar(self, df_5m_updated: pd.DataFrame) -> Action:
        """Process a new hourly bar. Re-runs prepare() and calls on_bar().

        Args:
            df_5m_updated: Full 5m DataFrame including the latest bars.
